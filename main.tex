...
\lettrineabstract{Healthcare is changing at a rapid pace: technology is evolving, and new treatements are being implemented at a breakneck pace on a global scale. However, healthcare still reamins limited in many aspects. One critial aspect is access—those who need healthcare do not always have oppertunities to recieve it in a timely and accesible manner. Consequently, a key question remains: how may we reduce the load on healthcare institutions and decrease the strain placed on healthcare workers? One potential avenue is by decreasing the burden of non-commicuable disease on hospitals and health care centers, where it accounts for 176.5 million outpatient causes \citep{ThailandsHealthChallenge2025}, a significant burden of all hospital visits.
This text was written as a part of the ``SCORE Research Camp x Hackathon 2025/26 “Health & Well-being in an Aging Society''}
